...
function TestUI()
{
	...
	function onBtnClick()
	{
		...
		// App.EffectUtils.macIconShake(this.btn, 56);
		Logger.trace(App.StageUtils.stageW, App.StageUtils.stageH);
		Logger.trace(new Laya.Sprite());
		App.EffectUtils.startFlicker(this.btn);
		App.AudioManager.playMusic("");
	}
