...
export class TweenManager {
	public static createTween(): GTweener {
		if (!_inited) {
			timer.frameLoop(1, null, TweenManager.update);
			_inited = true;
		}
	...
	public static update(): void {
		var dt: number = timer.delta / 1000;
...
const _activeTweens: GTweener[] = [];
const _tweenerPool: GTweener[] = [];
