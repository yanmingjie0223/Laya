...
export class WebAudioSoundChannel extends SoundChannel {
	 ...
	 * 当前播放速率
	 */
	private _playbackRate: number = ILaya.SoundManager.playbackRate;
    ...
    play(): void {
        ...
        if (bufferSource.playbackRate.setTargetAtTime) {
            bufferSource.playbackRate.setTargetAtTime(this._playbackRate, this.context.currentTime, WebAudioSoundChannel.SetTargetDelay)
        } else {
		...
		if (this._playbackRate !== v) {
			...
			if (bufferSource) {
				if (bufferSource.playbackRate.setTargetAtTime) {
					...
					bufferSource.playbackRate.value = v;
				}
			}
		}
    }
