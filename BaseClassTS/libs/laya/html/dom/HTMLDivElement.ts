...
export class HTMLDivElement extends Sprite {
    ...
    */
    ...
    /**@private */
    private _onMouseClick(ev: Event): void {
        ...
        for (i = 0; i < len; i++) {
            ...
            if (tHit.rec.contains(tX, tY)) {
                tHit.touch.setTo(tX, tY);
                this._eventLink(tHit, ev);
            }
        }
    }

    /**@private */
    private _eventLink(tHit: HTMLHitRect, ev: Event): void {
        this.event(Event.LINK, [tHit, ev]);
    }
}
